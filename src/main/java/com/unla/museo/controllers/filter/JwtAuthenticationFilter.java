 ...
 * Establece el SecurityContext para uso en @RequiresPermissions y authorization
 */
@Component
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // ✅ CORREGIDO: Ahora extrae "permissions" (no "roles")
            ...
            // Mapear permisos a SimpleGrantedAuthority
            // Nota: No agregamos "ROLE_" porque los permisos ya vienen con su nombre completo
            List<SimpleGrantedAuthority> authorities = permissions.stream()
                    .map(SimpleGrantedAuthority::new)
                    .toList();

            // Creación del objeto de autenticación en Spring Security
            ...
            // Si el token es inválido o expiró, se limpia el contexto y continúa.
            // Spring Security responderá 401 Unauthorized automáticamente al no haber auth.
